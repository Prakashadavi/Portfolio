...
import { FaEnvelope, FaMapMarkerAlt, FaPhone, FaGithub, FaLinkedin, FaTwitter, FaDribbble } from "react-icons/fa";
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="pt-4">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <a
                                    href="#"
                                    className="w-12 h-12 rounded-full bg-dark-300 flex items-center justify-center text-blue hover:bg-purple hover:text-white transition duration-300"
                                >
                                    <FaTwitter />
                                </a>
                                <a
